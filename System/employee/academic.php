...
<head>
	...
	<title>NSU Job Scopes - Academic Qualifications</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
														...
														<a  target="_blank" href="view-certificate-c.php?id=<?php echo $row['id']; ?>" >
															...
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-graduation-cap text-primary mr-5"></i><strong class="mr-10"><?php echo $row['institution']; ?></strong> <i class="fa fa-map-marker text-primary mr-5"></i> <?php echo $row['district_name']; ?>.
																</div>
									...
									<option <?php if ($level == "SSC") { print ' selected '; } ?>  value="SSC">SSC</option>
									<option <?php if ($level == "HSC") { print ' selected '; } ?>  value="HSC">HSC</option>
                                    <option <?php if ($level == "A Level") { print ' selected '; } ?>  value="A Level">A Level</option>
                                    <option <?php if ($level == "O Level") { print ' selected '; } ?>  value="O Level">O Level</option>
                                    <option <?php if ($level == "Bachelor Degree") { print ' selected '; } ?>  value="Bachelor Degree">Bachelor Degree</option>
									...
									<select name="district_name" required class="selectpicker show-tick form-control" data-live-search="true">
									<option disabled value="">Select</option>
						            <?php
									$stmtb = $conn->prepare("SELECT * FROM tbl_districts ORDER BY district_name");
                                    $stmtb->execute();
                                    ...
                                    {
										?>
										<option <?php if ($district_name == $rowb['district_name']) { print ' selected '; } ?> value="<?php echo $rowb['district_name']; ?>"><?php echo $rowb['district_name']; ?></option>
										<?php
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Attach your certificate (Mandatory)</label>
							        ...
							        <div class="form-group"> 
								    <label>Academic Transcript (Mandatory)</label>

...
header("location:../qualifications.php?r=2290");
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_professional_qualification (member_no, district_name, institution, title, timeframe, certificate) VALUES (:memberno, :district_name, :institution, :title, :timeframe, '$certificate')");

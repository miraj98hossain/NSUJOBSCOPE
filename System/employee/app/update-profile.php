...
$phone = $_POST['phone'];
	...
	$stmt = $conn->prepare("UPDATE tbl_users SET first_name = :fname, last_name = :lname, gender = :gender, bdate = :bdate , bmonth = :bmonth , byear = :byear, email = :email, education = :education, title = :title, city = :city, street = :street, zip = :zip, phone = :phone, about = :about WHERE member_no='$myid'");

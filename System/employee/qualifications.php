...
<head>
	...
	<title>NSU Job Scopes - Professional Qualifications</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option disabled value="">Select</option>
										...
										<option <?php if ($district_name == $row['district_name'] ) { print ' selected '; } ?> value="<?php echo $row['district_name']; ?>"><?php echo $row['district_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();

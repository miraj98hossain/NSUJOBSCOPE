...
<head>
	...
	<title>NSU Job Scopes - Other Attachments</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a target="_blank" href="mycv.php" class="btn btn-primary btn-sm btn-inverse">View my CV</a>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM tbl_cv WHERE member_no = '$myid' ORDER BY id LIMIT $page1,5");
                                    $stmt->execute();
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a  target="_blank" href="view-cv.php?id=<?php echo $row['id']; ?>" >
									...
									<a href="app/drop-cv.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this attachment ?')" class="btn btn-primary btn-sm btn-inverse">Delete</a>
									...
									<form action="app/update-cv.php" method="POST" autocomplete="off" enctype="multipart/form-data">
								    ...
								    <label> Upload Your Cv <i>(Leave blank if you dont want to update)</i></label>
								...
								require '../constants/db_config.php';
                                    ...
                                    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                    $stmt = $conn->prepare("SELECT * FROM tbl_cv WHERE member_no = '$myid' ORDER BY id");
                                    $stmt->execute();
                                    $result = $stmt->fetchAll();
                                    foreach($result as $row)
                                    {
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="mycv.php?page='.$prevpage.'"';} print '><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?> href="mycv.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="mycv.php?page='.$nextpage.'"';} print '><i class="fa fa-chevron-right"></i></a></li>';
					             }
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn btn-primary btn-lg">Add</a>
				                    ...
				                    <div class="modal-body">
									<form action="app/add-cv.php" method="POST" autocomplete="off" enctype="multipart/form-data">
					                <div class="row gap-20">

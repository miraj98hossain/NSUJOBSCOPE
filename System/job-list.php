...
$cate = $_GET['category'];
$city = $_GET['city'];	
$query1 = "SELECT * FROM tbl_jobs WHERE category = :cate AND city = :city ORDER BY enc_id DESC LIMIT $page1,12";
$query2 = "SELECT * FROM tbl_jobs WHERE category = :cate AND city = :city ORDER BY enc_id DESC";
$fromsearch = true;

$slc_city = "$city";
$slc_category = "$cate";
$title = "$slc_category jobs in $slc_city";
}else{
...
<head>
	...
	<title>Nsu Jobs Scopes - <?php echo "$title"; ?></title>
	<meta name="description" content="Online Job Management / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, company, worker, career, recruiting, recruitment" />
	<meta name="author" content="NSU Job Scopes">
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<option value="">-Select city-</option>
                                         ...
                                         $stmt = $conn->prepare("SELECT * FROM tbl_districts ORDER BY district_name");
                                         $stmt->execute();
                                         $result = $stmt->fetchAll();
                                         ...
                                         {
											  $cnt = $row['district_name'];
                                        ?>
										
										<option <?php if ($slc_city== "$cnt") { print ' selected '; } ?> value="<?php echo $row['district_name']; ?>"><?php echo $row['district_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a target="" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">View This Job</a>
													</div>
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="job-list.php?page='.$prevpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&city='.$city.'&search=✓'; }'';} print '"><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="job-list.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&category='.$cate.'&city='.$city.'&search=✓'; }?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="job-list.php?page='.$nextpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&city='.$city.'&search=✓'; }'';} print '"><i class="fa fa-chevron-right"></i></a></li>';
					             }

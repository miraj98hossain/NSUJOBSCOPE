...
<head>
	...
	<title>NSU Job Scopes - <?php echo "$compname"; ?></title>
	<meta name="description" content="Online Job Management / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, company, worker, career, recruiting, recruitment" />
	<meta name="author" content="NSUjobscopes">
		...
		<header id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<a class="navbar-brand .branding" href="#">NSU Job Scope</a>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<p class="location"> <i class="fa fa-map-marker"></i> <?php echo "$compcity" ; ?>, <?php echo "$compstreet"; ?>.<?php echo "$compzip"; ?> </p>
									    <p class="location"><i class="fa fa-phone"></i> <?php echo "$compphone"; ?></p>
										...
										<ul class="meta-list clearfix">
											...
											<li>
												...
												<a target="" href="https://<?php echo "$compweb"; ?>"><?php echo "$compweb"; ?></a>
											</li>
										</ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span><a href="mailto:abdullah.shafi1@northsouth.edu">abdullah.shafi1@northsouth.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="footer-text">
                                ...
                                <p>NSU Job Scopes is a job portal, online job management system developed by Team Zero Factorial.</p>
                            </div>

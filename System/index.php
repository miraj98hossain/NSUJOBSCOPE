...
<head>
	...
	<!-- have to check these two upper  images -->
    
	<meta property="og:image:type" content="image/jpeg" />
    <meta property="og:image:width" content="500" />
    <meta property="og:image:height" content="300" />
    <meta property="og:image:alt" content="NSU Job Scope" /> <!-- Edited -->
    <meta property="og:description" content="Online Job Management / NSU Job Portal" /> <!-- Edited -->

	<link rel="shortcut icon" href="images/ico/NSU_favicon3.png"> <!-- Edited -->
...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<header id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<!--  below comented code will be shown at next project showcase -->
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/NSU_job_hero1.jpg');">
				<div class="container">

					<h1>Your bright future starts here now</h1>
					<p>Finding your next job or career on NSU Job Scopes</p>
							...
							<div class="form-holder">
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										...
										<option style="color:black" value="<?php echo $row['district_name']; ?>"><?php echo $row['district_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					?>
						 ...
						 <!-- Commented out the random companies group -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							?>
							<a class="recent-job-item clearfix" target="" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>">
							...
							<i class="fa fa-map-marker text-primary"></i> </strong> - <?php echo "$jobcity" ?>
							</div>
							</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span><a href="mailto:>nsu.jobscopes@gmail.com">nsu.jobscopes@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>

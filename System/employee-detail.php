...
<head>
	...
	<title>Nsu Job Scopes - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
									...
									<div class="employee-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											<li>
												...
												<?php
												if(is_numeric($bdate)&& is_numeric($bmonth)&& is_numeric($bmonth)){
													echo "$bdate"; ?>/<?php echo "$bmonth"; ?>/<?php echo "$byear";
												}else{
									...
									<div class="employee-detail-company-overview mt-40 clearfix">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<p class="text-muted font-italic">Level - <?php echo $row['level']; ?> , <?php echo $row['timeframe']; ?><span class="font300 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['district_name']; ?></p>
												<p><a target="" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
												</li>
												<?php
	                                            }
										...
										<h3>Work Experience</h3>
											<ul class="employee-detail-list">
												...
												<p class="text-muted font-italic"><?php echo $row['start_date']; ?> to <?php echo $row['end_date']; ?><span class="font300 text-primary"> <?php echo $row['institution']; ?></span></p>
												<p>Supervisor : <span class="font300 text-primary"> <?php echo $row['supervisor']; ?></span> , Phone : <span class="font300 text-primary"> <?php echo $row['supervisor_phone']; ?></span> <br><?php echo $row['duties']; ?></p>
												</li>
												<?php
	                                            }
										...
										<h3>Training & Workshop</h3>
												...
												<p class="text-muted font-italic"><span class="font300 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['timeframe']; ?></p>
												<?php
												if ($certificate == "") {
													
												}else{
												?>
                                                <p><a target="" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-b.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
                                                <?php												
												}
										...
										<h3>Professional Qualifications</h3>
											    ...
											    <li>
												<h5><?php echo $row['title']; ?> </h5>
												<p class="text-muted font-italic"><?php echo $row['timeframe']; ?><span class="font300 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['district_name']; ?></p>
												<p><a target="" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-c.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
												</li>
												<?php
	                                            }
                                                ...
                                                $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                                $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                                $stmt = $conn->prepare("SELECT * FROM tbl_cv WHERE member_no = :empid ORDER BY id");
	                                            $stmt->bindParam(':empid', $empid);
                                                $stmt->execute();
                                                $result = $stmt->fetchAll();
	                                            $rec = count($result);
												...
												<p><a target="" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-cv.php?id=<?php echo $row['id']; ?>">View Cv</a></p>
												</li>
												<?php
	                                            }
											...
											<h3>Other Attachments</h3>
												...
												<li>
												<h5><?php echo $row['title']; ?> </h5>
												<p class="font300 text-primary"><?php echo $row['issuer']; ?></p>
												<p><a target="" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-attachment.php?id=<?php echo $row['id']; ?>">View Attachment</a></p>
												</li>
												<?php
	                                            }
										...
										<h3>Language Proficiency</h3>
												...
												<p class="text-muted font-italic">Speaking <span class="font300 text-primary"> <?php echo $row['speak']; ?></span> , Reading <span class="font300 text-primary"> <?php echo $row['reading']; ?></span> , Writing <span class="font300 text-primary"> <?php echo $row['writing']; ?></span></p>
												</li>
												<?php
	                                            }
										...
										<ul class="list-icon">
											...
											<li>
												...
												<p><?php echo $row['ref_title']; ?> <span class="font300 text-primary"><?php echo $row['institution']; ?></span></p>

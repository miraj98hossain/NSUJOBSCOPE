...
$stmt = $conn->prepare("INSERT INTO tbl_jobs (job_id, title, city, category, type, experience, description, responsibility, requirements, company, date_posted, closing_date)
 VALUES (:jobid, :title, :city, :category, :type, :experience, :description, :responsibility, :requirements, :company, :dateposted, :closingdate)");

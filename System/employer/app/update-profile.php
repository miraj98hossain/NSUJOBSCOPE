...
$myemail = $_POST['email'];
	...
	if ($rec == "0") {
    $stmt = $conn->prepare("UPDATE tbl_users SET first_name = :compname, byear = :esta, title = :type, city = :city, street = :street, zip = :zip, phone = :phone, about = :about, services = :service, expertise = :expertise, people = :people, website = :website WHERE member_no='$myid'");
